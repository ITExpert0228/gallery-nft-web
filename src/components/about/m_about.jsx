      ...
      <Row>
        <Col lg={6} md={6} sm={12} className="col-xs-12">
          <div className="about-content">
            ...
            <p>You see... some teddy bears come from loving happy homes.<br />But some unfortunate little souls come from the most horrible homes imaginable.</p>
            
            <p>Little Jay was spawned from hell and recentment.  Resenting all of those happy little teddy bears and vowing to kill each and everyone of them that cross his path. <br />If you have a teddy bear and you live deep in the woods, I would be very careful Little Jay doesn't come pay you and your happy loving little teddy bear a visit that neither of you will ever forget...</p>
            <p></p>
      ...
      <div id='about' className="wd_scroll_wrap wd_scroll">
        ...
        <div className="sud">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1920 181.1" style={{enableBackground:"new 0 0 1920 181.1"}} space="preserve">
              <g>
                  <path style={{fillRule:'evenodd',clipRule:'evenodd',fill: this.props.fill ? this.props.fill : '#f1f1f4'  }} className="st0" d="M0,80c0,0,28.9-4.2,43-13c14.3-9,71-35.7,137,5c17.3,7.7,33.3,13,48,11c17.3,0.3,50.3,4.7,66,23
